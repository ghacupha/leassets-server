...
import tech.leassets.service.LeassetsFileTypeService;
import tech.leassets.service.dto.LeassetsFileTypeCriteria;
import tech.leassets.service.LeassetsFileTypeQueryService;
...
public class LeassetsFileTypeResourceIT {
     ...
     *
     * @see tech.leassets.repository.search.LeassetsFileTypeSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createLeassetsFileType() throws Exception {
        ...
        restLeassetsFileTypeMockMvc.perform(post("/api/leassets-file-types")
    ...
    public void getAllLeassetsFileTypes() throws Exception {
        ...
        restLeassetsFileTypeMockMvc.perform(get("/api/leassets-file-types?sort=id,desc"))
    ...
    public void getLeassetsFileType() throws Exception {
        ...
        restLeassetsFileTypeMockMvc.perform(get("/api/leassets-file-types/{id}", leassetsFileType.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getAllLeassetsFileTypesByLeassetsFileTypeNameIsInShouldWork() throws Exception {
        ...
        defaultLeassetsFileTypeShouldBeFound("leassetsFileTypeName.in=" + DEFAULT_LEASSETS_FILE_TYPE_NAME + "," + UPDATED_LEASSETS_FILE_TYPE_NAME);
    ...
    public void getAllLeassetsFileTypesByLeassetsFileMediumTypeIsInShouldWork() throws Exception {
        ...
        defaultLeassetsFileTypeShouldBeFound("leassetsFileMediumType.in=" + DEFAULT_LEASSETS_FILE_MEDIUM_TYPE + "," + UPDATED_LEASSETS_FILE_MEDIUM_TYPE);
    ...
    private void defaultLeassetsFileTypeShouldBeFound(String filter) throws Exception {
        restLeassetsFileTypeMockMvc.perform(get("/api/leassets-file-types?sort=id,desc&" + filter))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(leassetsFileType.getId().intValue())))
            .andExpect(jsonPath("$.[*].leassetsFileTypeName").value(hasItem(DEFAULT_LEASSETS_FILE_TYPE_NAME)))
        ...
        restLeassetsFileTypeMockMvc.perform(get("/api/leassets-file-types/count?sort=id,desc&" + filter))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingLeassetsFileType() throws Exception {
        // Get the leassetsFileType
        restLeassetsFileTypeMockMvc.perform(get("/api/leassets-file-types/{id}", Long.MAX_VALUE))
    ...
    public void updateLeassetsFileType() throws Exception {
        ...
        restLeassetsFileTypeMockMvc.perform(put("/api/leassets-file-types")
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteLeassetsFileType() throws Exception {
        ...
        restLeassetsFileTypeMockMvc.perform(delete("/api/leassets-file-types/{id}", leassetsFileType.getId())
    ...
    public void searchLeassetsFileType() throws Exception {
        ...
        restLeassetsFileTypeMockMvc.perform(get("/api/_search/leassets-file-types?query=id:" + leassetsFileType.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(leassetsFileType.getId().intValue())))
            .andExpect(jsonPath("$.[*].leassetsFileTypeName").value(hasItem(DEFAULT_LEASSETS_FILE_TYPE_NAME)))
