...
import tech.leassets.service.FixedAssetDepreciationService;
...
import tech.leassets.service.FixedAssetDepreciationQueryService;
...
public class FixedAssetDepreciationResourceIT {
     ...
     *
     * @see tech.leassets.repository.search.FixedAssetDepreciationSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createFixedAssetDepreciation() throws Exception {
        ...
        restFixedAssetDepreciationMockMvc.perform(post("/api/fixed-asset-depreciations")
    ...
    public void updateFixedAssetDepreciation() throws Exception {
        ...
        restFixedAssetDepreciationMockMvc.perform(put("/api/fixed-asset-depreciations")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(fixedAssetDepreciationDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteFixedAssetDepreciation() throws Exception {
        ...
        restFixedAssetDepreciationMockMvc.perform(delete("/api/fixed-asset-depreciations/{id}", fixedAssetDepreciation.getId())
