...
import tech.leassets.repository.FixedAssetNetBookValueRepository;
import tech.leassets.repository.search.FixedAssetNetBookValueSearchRepository;
import tech.leassets.service.FixedAssetNetBookValueService;
...
import tech.leassets.service.dto.FixedAssetNetBookValueCriteria;
import tech.leassets.service.FixedAssetNetBookValueQueryService;
...
public class FixedAssetNetBookValueResourceIT {
     ...
     *
     * @see tech.leassets.repository.search.FixedAssetNetBookValueSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createFixedAssetNetBookValue() throws Exception {
        ...
        restFixedAssetNetBookValueMockMvc.perform(post("/api/fixed-asset-net-book-values")
    ...
    public void updateFixedAssetNetBookValue() throws Exception {
        ...
        restFixedAssetNetBookValueMockMvc.perform(put("/api/fixed-asset-net-book-values")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(fixedAssetNetBookValueDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteFixedAssetNetBookValue() throws Exception {
        ...
        restFixedAssetNetBookValueMockMvc.perform(delete("/api/fixed-asset-net-book-values/{id}", fixedAssetNetBookValue.getId())
