...
import static io.github.leassets.web.rest.TestUtil.sameNumber;
...
class FixedAssetAcquisitionResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/fixed-asset-acquisitions";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/fixed-asset-acquisitions";
     ...
     *
     * @see io.github.leassets.repository.search.FixedAssetAcquisitionSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void partialUpdateFixedAssetAcquisitionWithPatch() throws Exception {
        ...
        partialUpdatedFixedAssetAcquisition.assetNumber(UPDATED_ASSET_NUMBER);
    ...
    void searchFixedAssetAcquisition() throws Exception {
        ...
        fixedAssetAcquisitionRepository.saveAndFlush(fixedAssetAcquisition);
        when(
            mockFixedAssetAcquisitionSearchRepository.search(queryStringQuery("id:" + fixedAssetAcquisition.getId()), PageRequest.of(0, 20))
        )
