...
class FixedAssetDepreciationResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/fixed-asset-depreciations";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/fixed-asset-depreciations";
    ...
    void searchFixedAssetDepreciation() throws Exception {
        ...
        fixedAssetDepreciationRepository.saveAndFlush(fixedAssetDepreciation);
        when(
            mockFixedAssetDepreciationSearchRepository.search(
                queryStringQuery("id:" + fixedAssetDepreciation.getId()),
                PageRequest.of(0, 20)
            )
        )
