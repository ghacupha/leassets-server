...
import io.github.leassets.service.criteria.FixedAssetNetBookValueCriteria;
...
/**
 * REST controller for managing {@link io.github.leassets.domain.FixedAssetNetBookValue}.
 */
@RestController
@RequestMapping("/api")
public class FixedAssetNetBookValueResource {
    ...
    private static final String ENTITY_NAME = "fixedAssetNetBookValue";
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/fixed-asset-net-book-values/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<FixedAssetNetBookValueDTO> partialUpdateFixedAssetNetBookValue(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, fixedAssetNetBookValueDTO.getId().toString())
        );
    }
