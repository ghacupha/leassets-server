...
/**
 * REST controller for managing {@link io.github.leassets.domain.FixedAssetDepreciation}.
 */
@RestController
@RequestMapping("/api")
public class FixedAssetDepreciationResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/fixed-asset-depreciations/{id}", consumes = "application/merge-patch+json")
