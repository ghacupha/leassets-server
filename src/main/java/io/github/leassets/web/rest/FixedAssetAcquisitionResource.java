...
/**
 * REST controller for managing {@link io.github.leassets.domain.FixedAssetAcquisition}.
 */
@RestController
@RequestMapping("/api")
public class FixedAssetAcquisitionResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/fixed-asset-acquisitions/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<FixedAssetAcquisitionDTO> partialUpdateFixedAssetAcquisition(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, fixedAssetAcquisitionDTO.getId().toString())
        );
    }
