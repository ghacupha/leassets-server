...
public class FileNotification implements TokenizableMessage<String> {
    ...
    public FileNotification(
        ...
        String messageToken,
        String description,
        LeassetsFileModelType leassetsfileModelType
    ) {
        this.fileId = fileId;
    ...
    public boolean equals(final Object o) {
        ...
        if (this$messageToken == null ? other$messageToken != null : !this$messageToken.equals(other$messageToken)) return false;
        ...
        if (
            this$leassetsfileModelType == null
                ? other$leassetsfileModelType != null
                : !this$leassetsfileModelType.equals(other$leassetsfileModelType)
        ) return false;
        return true;
    }
    ...
    public String toString() {
        return (
            ...
            ", description=" +
            this.getDescription() +
            ", leassetsfileModelType=" +
            this.getleassetsfileModelType() +
            ")"
        );
    }
    ...
    public static class FileNotificationBuilder {
        ...
        public FileNotification.FileNotificationBuilder leassetsfileModelType(LeassetsFileModelType leassetsfileModelType) {
            this.leassetsfileModelType = leassetsfileModelType;
            return this;
        }
        ...
        public String toString() {
            return (
                "FileNotification.FileNotificationBuilder(fileId=" +
                this.fileId +
                ", timestamp=" +
                this.timestamp +
                ", filename=" +
