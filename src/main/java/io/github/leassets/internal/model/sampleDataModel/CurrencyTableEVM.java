...
public class CurrencyTableEVM implements Serializable {
    ...
    public boolean equals(final Object o) {
        ...
        if (this$currencyName == null ? other$currencyName != null : !this$currencyName.equals(other$currencyName)) return false;
    ...
    public static class CurrencyTableEVMBuilder {
        ...
        public String toString() {
            return (
                "CurrencyTableEVM.CurrencyTableEVMBuilder(rowIndex=" +
                this.rowIndex +
                ", currencyCode=" +
                this.currencyCode +
                ", locality=" +
