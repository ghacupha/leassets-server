...
public class FixedAssetDepreciationEVM implements Serializable {
    ...
    public FixedAssetDepreciationEVM(Long rowIndex, Long assetNumber, String serviceOutletCode, String assetTag, String assetDescription, String depreciationDate, String assetCategory, double depreciationAmount, String depreciationRegime, String fileUploadToken, String compilationToken) {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(that.getDepreciationAmount(), getDepreciationAmount()) == 0 && Objects.equals(getRowIndex(), that.getRowIndex()) && Objects.equals(getAssetNumber(), that.getAssetNumber()) && Objects.equals(getServiceOutletCode(), that.getServiceOutletCode()) && Objects.equals(getAssetTag(), that.getAssetTag()) && Objects.equals(getAssetDescription(), that.getAssetDescription()) && Objects.equals(getDepreciationDate(), that.getDepreciationDate()) && Objects.equals(getAssetCategory(), that.getAssetCategory()) && Objects.equals(getDepreciationRegime(), that.getDepreciationRegime()) && Objects.equals(getFileUploadToken(), that.getFileUploadToken()) && Objects.equals(getCompilationToken(), that.getCompilationToken());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getRowIndex(), getAssetNumber(), getServiceOutletCode(), getAssetTag(), getAssetDescription(), getDepreciationDate(), getAssetCategory(), getDepreciationAmount(), getDepreciationRegime(), getFileUploadToken(), getCompilationToken());
    }
