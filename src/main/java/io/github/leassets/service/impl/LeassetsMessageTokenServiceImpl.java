...
public class LeassetsMessageTokenServiceImpl implements LeassetsMessageTokenService {
    ...
    public LeassetsMessageTokenServiceImpl(
        LeassetsMessageTokenRepository leassetsMessageTokenRepository,
        LeassetsMessageTokenMapper leassetsMessageTokenMapper,
        LeassetsMessageTokenSearchRepository leassetsMessageTokenSearchRepository
    ) {
    ...
    public Page<LeassetsMessageTokenDTO> findAll(Pageable pageable) {
        ...
        return leassetsMessageTokenRepository.findAll(pageable).map(leassetsMessageTokenMapper::toDto);
    }
    ...
    public Optional<LeassetsMessageTokenDTO> findOne(Long id) {
        ...
        return leassetsMessageTokenRepository.findById(id).map(leassetsMessageTokenMapper::toDto);
    }
    ...
    public Page<LeassetsMessageTokenDTO> search(String query, Pageable pageable) {
        ...
        return leassetsMessageTokenSearchRepository.search(queryStringQuery(query), pageable).map(leassetsMessageTokenMapper::toDto);
    }
}
