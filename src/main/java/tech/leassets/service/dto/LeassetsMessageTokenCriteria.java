...
/**
 * Criteria class for the {@link tech.leassets.domain.LeassetsMessageToken} entity. This class is used
 * in {@link tech.leassets.web.rest.LeassetsMessageTokenResource} to receive all the possible filtering options from
